...
"}")
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 90, 271, 530))
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboCategoria.sizePolicy().hasHeightForWidth())
        self.comboCategoria.setSizePolicy(sizePolicy)
        self.comboCategoria.setMinimumSize(QtCore.QSize(150, 0))
        self.comboCategoria.setStyleSheet("QComboBox {\n"
"    padding: 10px;\n"
...
"")
        ...
        self.verticalLayout.addWidget(self.comboCategoria)
