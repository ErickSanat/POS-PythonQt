...
"}")
        ...
        self.searchInput_10 = QtWidgets.QLineEdit(self.verticalLayoutWidget_2)
        self.searchInput_10.setMinimumSize(QtCore.QSize(40, 0))
        self.searchInput_10.setStyleSheet("QLineEdit {\n"
"    padding: 10px;\n"
"    border: 2px solid #867BAA;\n"
"    border-radius: 20px;\n"
"    font-size: 14px;\n"
"    color: rgb(134, 123, 170);\n"
"}")
        self.searchInput_10.setText("")
        self.searchInput_10.setObjectName("searchInput_10")
        self.verticalLayout.addWidget(self.searchInput_10)
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.saleTitleLabel_3.setText(_translate("Form", "Proveedor:"))
        self.label_4.setText(_translate("Form", "Nombre:"))
        self.searchInput_3.setPlaceholderText(_translate("Form", "Nombre del proveedor..."))
        self.label_12.setText(_translate("Form", "Nombre de contacto:"))
        self.searchInput_10.setPlaceholderText(_translate("Form", "Nombre del contacto..."))
        self.label_6.setText(_translate("Form", "Teléfono:"))
        self.searchInput_4.setPlaceholderText(_translate("Form", "Teléfono del proveedor..."))
        self.label_13.setText(_translate("Form", "Dirección:"))
        ...
        self.saleTitleLabel_2.setText(_translate("Form", "Encontrar proveedores por:"))
