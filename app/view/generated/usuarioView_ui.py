...
"}")
        ...
        self.labelUsuario_2 = QtWidgets.QLabel(self.frame)
        self.labelUsuario_2.setGeometry(QtCore.QRect(20, 410, 251, 21))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labelUsuario_2.sizePolicy().hasHeightForWidth())
        self.labelUsuario_2.setSizePolicy(sizePolicy)
        self.labelUsuario_2.setStyleSheet("color: rgb(0, 0, 0);")
        self.labelUsuario_2.setText("")
