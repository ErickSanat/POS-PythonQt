...
"}")
        ...
        self.labelContrasena = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labelContrasena.sizePolicy().hasHeightForWidth())
        self.labelContrasena.setSizePolicy(sizePolicy)
        self.labelContrasena.setStyleSheet("color: rgb(0, 0, 0);")
        self.labelContrasena.setObjectName("labelContrasena")
        self.verticalLayout.addWidget(self.labelContrasena)
        self.lineContrasena = QtWidgets.QLineEdit(self.verticalLayoutWidget_2)
        self.lineContrasena.setMinimumSize(QtCore.QSize(40, 0))
...
"}")
        ...
        self.labelRol = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labelRol.sizePolicy().hasHeightForWidth())
        self.labelRol.setSizePolicy(sizePolicy)
        self.labelRol.setStyleSheet("color: rgb(0, 0, 0);")
        self.labelRol.setObjectName("labelRol")
        self.verticalLayout.addWidget(self.labelRol)
        self.comboRol = QtWidgets.QComboBox(self.verticalLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboRol.sizePolicy().hasHeightForWidth())
        self.comboRol.setSizePolicy(sizePolicy)
        self.comboRol.setMinimumSize(QtCore.QSize(150, 0))
...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.tituloEmpleado.setText(_translate("Dialog", "Usuario:"))
        self.labelUsuario.setText(_translate("Dialog", "usuario:"))
        self.lineNombreEmpleado.setPlaceholderText(_translate("Dialog", "Nombre del usuario..."))
        self.labelContrasena.setText(_translate("Dialog", "Contraseña:"))
        self.lineContrasena.setPlaceholderText(_translate("Dialog", "Contraseña del usuario..."))
        self.labelRol.setText(_translate("Dialog", "Rol:"))
        ...
        self.labelEncontrar.setText(_translate("Dialog", "Encontrar usuario por:"))
